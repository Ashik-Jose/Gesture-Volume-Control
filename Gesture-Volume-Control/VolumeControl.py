...
while True:
    ...
    if len(lmList) !=0 :
        ...
        cv2.circle(img, (x1,y1), 12, (255,150,200), cv2.FILLED)
        cv2.circle(img, (x2,y2), 12, (255,150,200), cv2.FILLED)
    ...
    cv2.putText(img,f'FPS: {int(fps)}',(48,50),cv2.FONT_HERSHEY_SIMPLEX,2, (255,0,0),5)
